...
const requiredPaths: readonly string[] = [
  ...
  'examples/node-http/run-example.ts',
  'examples/node-http/runtime-evidence.yaml',
  'examples/node-http/scenarios/version.yaml',
  'examples/node-http/service.ts',
  ...
  'tests/acceptance/contract.ts',
  'tests/acceptance/diagnostics.ts',
  'tests/acceptance/harness.ts',
  'tests/acceptance/README.md',
  'tests/acceptance/v0.1.test.ts',
  'scripts/clean.ts',
